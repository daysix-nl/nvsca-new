   ...
   <section class="bg-white <?php echo get_field('padding_top');?> <?php echo get_field('padding_bottom');?>">
        <div class="container">
            <div class="form-titel mb-[35px] lg:mb-[40px] xl:mb-[45px]">
                <h2 class="pt-2 text-22 leading-33 md:text-21 md:leading-28 lg:text-22 lg:leading-29 xl:text-25 xl:leading-33 font-satoshi text-black font-semibold">Nieuwe inschrijving</h2>
            </div>
